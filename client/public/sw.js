// Examaye Service Worker — Offline Support + Caching
...
<body>
  <div class="card">
    ...
    <p>Examaye needs an internet connection. Please check your network and try again.</p>
...
self.addEventListener('push', event => {
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || 'Examaye', {
      body: data.body || '',
