...
const PRODUCTS = [
  { icon:'🤖', name:'StudyNavo AI',         desc:'Your personal AI tutor.' },
  { icon:'📚', name:'StudyNavo Library',    desc:'WAEC, NECO, JAMB and GCE learning resources.' },
  { icon:'📝', name:'StudyNavo CBT',        desc:'Realistic computer-based examination simulations.' },
  { icon:'🧠', name:'StudyNavo Tutor',      desc:'AI explanations for difficult questions.' },
  { icon:'📊', name:'StudyNavo Analytics',  desc:'Performance tracking and weak-topic identification.' },
  { icon:'🎯', name:'StudyNavo Coach',      desc:'Personalised study plans.' },
  { icon:'🎓', name:'StudyNavo Admissions', desc:'JAMB score guidance, university information and admission planning.' },
  { icon:'🏆', name:'StudyNavo Challenge',  desc:'Competitions, leaderboards and rewards.' },
  { icon:'👨‍👩‍👧', name:'StudyNavo Parent', desc:'Parents can monitor their child\'s study progress.' },
];
...
const SUBJECTS = [
  { name:'Mathematics',         icon:'📐', color:'#4F6EF7' },
  ...
  { name:'Computer Science',    icon:'💻', color:'#4F6EF7' },
    ...
    <div style={{ minHeight:'100dvh', background:'var(--bg-base)', overflowX:'hidden' }}>
      ...
      <nav style={{
        ...
        <div style={{ display:'flex', alignItems:'center', gap:10 }}>
          <div style={{ width:32, height:32, borderRadius:9, background:'linear-gradient(135deg,#3B4FD9,#7C93FA)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:16, fontWeight:900, color:'#fff', boxShadow:'0 2px 10px rgba(79,110,247,0.4)' }}>S</div>
          <span style={{ fontFamily:'var(--font-display)', fontSize:16, fontWeight:800, letterSpacing:'-0.02em' }}>StudyNavo</span>
      ...
      <section style={{
        ...
        background:'radial-gradient(ellipse at 50% 0%, rgba(79,110,247,0.15) 0%, transparent 60%)',
      }}>
        {/* Floating orbs */}
        <div style={{ position:'absolute', top:'15%', left:'8%', width:300, height:300, background:'radial-gradient(circle, rgba(79,110,247,0.12), transparent)', borderRadius:'50%', pointerEvents:'none', animation:'float 6s ease-in-out infinite' }}/>
        ...
        <div style={{ animation:'fadeInUp 0.6s both', position:'relative', zIndex:1 }}>
          <div style={{ display:'inline-flex', alignItems:'center', gap:8, padding:'6px 16px', borderRadius:'var(--r-full)', background:'var(--brand-dim)', border:'1px solid rgba(79,110,247,0.3)', marginBottom:24 }}>
      ...
      <section style={{ padding:'80px 24px', background:'var(--bg-surface)' }}>
        <div style={{ maxWidth:1100, margin:'0 auto' }}>
          <div style={{ textAlign:'center', marginBottom:48 }}>
            <span style={{ fontSize:12, fontWeight:700, color:'var(--brand-light)', letterSpacing:'0.08em', textTransform:'uppercase' }}>The StudyNavo Ecosystem</span>
            ...
            <p style={{ color:'var(--text-muted)', fontSize:15, maxWidth:560, margin:'0 auto' }}>
              StudyNavo isn't just an app — it's a complete examination ecosystem built for how Nigerian students actually study, practice, and prepare.
            </p>
          </div>
      ...
      <section style={{ padding:'80px 24px' }}>
        <div style={{ maxWidth:1100, margin:'0 auto' }}>
          <div style={{ textAlign:'center', marginBottom:48 }}>
            <h2 style={{ fontSize:'clamp(1.6rem,4vw,2.4rem)', marginBottom:12 }}>Why StudyNavo?</h2>
      ...
      <section style={{ padding:'80px 24px', background:'linear-gradient(135deg,var(--brand-dark),var(--brand))', textAlign:'center', position:'relative', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', zIndex:1 }}>
          ...
          <p style={{ color:'rgba(255,255,255,0.75)', fontSize:15, marginBottom:32, maxWidth:500, margin:'0 auto 32px' }}>
            Join thousands of Nigerian students already using StudyNavo to prepare smarter and score higher.
          </p>
      ...
      <footer style={{ padding:'32px 24px', textAlign:'center', borderTop:'1px solid var(--border)', background:'var(--bg-surface)' }}>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:10, marginBottom:12 }}>
          <div style={{ width:28, height:28, borderRadius:8, background:'linear-gradient(135deg,#3B4FD9,#7C93FA)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:13, fontWeight:900, color:'#fff' }}>S</div>
          <span style={{ fontFamily:'var(--font-display)', fontWeight:800, fontSize:15 }}>StudyNavo</span>
        </div>
